...
import { Home, Search, FileText, BarChart3, Activity, Star } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { label: 'Analysis', href: '/markets/stock', icon: Activity },
  { label: 'Watchlist', href: '/markets/stock/watchlist', icon: Star },
];
