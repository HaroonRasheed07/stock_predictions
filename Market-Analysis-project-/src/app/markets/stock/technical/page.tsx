...
export default function TechnicalAnalysis() {
  ...
  if (isLoading) return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <Skeleton className="glass h-[200px] sm:h-[240px] rounded-xl" />
      <Skeleton className="glass h-[360px] sm:h-[520px] rounded-xl" />
      <Skeleton className="glass h-[240px] sm:h-[400px] rounded-xl" />
          ...
          <CardContent className="p-3 sm:p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl sm:text-2xl font-bold">{indicators?.rsi ?? 'N/A'}</p>
          ...
          <CardContent className="p-3 sm:p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl sm:text-2xl font-bold">{indicators?.macd ?? 'N/A'}</p>
          ...
          <CardContent className="p-3 sm:p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl sm:text-2xl font-bold text-success">{indicators?.signal ?? 'N/A'}</p>
