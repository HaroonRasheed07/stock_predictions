...
import { fetchHomeIntelligence, type HomeIntelligence } from '@/lib/api';
      ...
      <section className="relative overflow-hidden gradient-hero py-12 md:py-20">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-base md:text-lg text-foreground/60 mb-6 max-w-xl">
              AI-powered research, decision intelligence, and real-time market signals.
            </p>
      ...
      <div className="container mx-auto px-4 py-6 space-y-6">
        ...
        <section className="pt-6 pb-12">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              { icon: Brain, title: 'AI Predictions', desc: 'LSTM-powered 10-day forecasts' },
              { icon: Shield, title: 'Risk Intelligence', desc: 'Multi-factor risk assessment' },
              { icon: Zap, title: 'Real-Time Signals', desc: 'Live market event detection' },
            ].map((cap, idx) => (
              <motion.div
                key={idx}
                initial={{ opacity: 0, y: 10 }}
